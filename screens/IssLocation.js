...
import { Alert, Text, View, StyleSheet, Platform, SafeAreaView, Image, ImageBackground} from 'react-native';
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <ImageBackground source={require("../assets/bg.png")} styles={styles.bgIMG}>
